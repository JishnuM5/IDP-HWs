"""
Image Comparison Tool for HW3 : CSE 163 NCHS
Author: Vishal Yalla and Mr. Stride
"""
...
def compare_img(filename):
    leading, name = os.path.split(filename)
    expected = os.path.join(leading, 'expected', name)
    compare = os.path.join(leading, 'compare', name)
